...
var G3 = (h, i, n) => i in h ? N3(h, i, { enumerable: true, configurable: true, writable: true, value: n }) : h[i] = n;
var p = (h, i, n) => G3(h, typeof i != "symbol" ? i + "" : i, n);
var V3 = class {
...
var q3 = class {
  constructor() {
    p(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new V3() : new J3();
  }
  requestAnimationFrame(h) {
...
var Y3 = (() => {
  var _a;
  var h = typeof document < "u" ? (_a = document.currentScript) == null ? void 0 : _a.src : void 0;
  return function(i = {}) {
    var n;
    function d(t, e, a) {
    ...
    var u = i, W, V, J = new Promise((t, e) => {
      W = t, V = e;
    }), p1 = Object.assign({}, u), u1 = "./this.program", D = "", c1;
    ...
    var q = u.printErr || console.error.bind(console);
    Object.assign(u, p1), p1 = null, u.thisProgram && (u1 = u.thisProgram);
    var i1 = u.wasmBinary, K, l1 = false, _1, z, E, n1, Z, L, C, g1, w1;
    function s1() {
      var t = K.buffer;
      u.HEAP8 = z = new Int8Array(t), u.HEAP16 = n1 = new Int16Array(t), u.HEAPU8 = E = new Uint8Array(t), u.HEAPU16 = Z = new Uint16Array(t), u.HEAP32 = L = new Int32Array(t), u.HEAPU32 = C = new Uint32Array(t), u.HEAPF32 = g1 = new Float32Array(t), u.HEAPF64 = w1 = new Float64Array(t);
    }
    var k1 = [], x = [], M1 = [];
    function n3() {
    ...
    function D1(t) {
      var e;
      throw (e = u.onAbort) === null || e === void 0 || e.call(u, t), t = "Aborted(" + t + ")", q(t), l1 = true, t = new WebAssembly.RuntimeError(t + ". Build with -sASSERTIONS for more info."), V(t), t;
    }
    var w2 = (t) => t.startsWith("data:application/octet-stream;base64,"), F1;
    async function a3(t) {
      if (!i1) try {
        var e = await c1(t);
      ...
      if (t == F1 && i1) t = new Uint8Array(i1);
    ...
    async function r3(t, e) {
      try {
        ...
        q(`failed to asynchronously prepare wasm: ${r}`), D1(r);
      }
    }
    async function s3(t) {
      var e = F1;
      if (!i1 && typeof WebAssembly.instantiateStreaming == "function" && !w2(e) && typeof fetch == "function") try {
    ...
    class M2 {
      constructor(e) {
        d(this, "name", "ExitStatus"), this.message = `Program terminated with exit(${e})`, this.status = e;
      }
    }
    var Q1 = (t) => {
      for (; 0 < t.length; ) t.shift()(u);
    }, X1 = u.noExitRuntime || true, L2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, T1 = function() {
      let t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : NaN;
      var a = E, r = t + e;
      for (e = t; a[e] && !(e >= r); ) ++e;
      if (16 < e - t && a.buffer && L2) return L2.decode(a.subarray(t, e));
      for (r = ""; t < e; ) {
        var s = a[t++];
        if (s & 128) {
          var o = a[t++] & 63;
    ...
    var f1 = {}, h1 = {}, W1 = {}, b1, a1 = (t, e, a) => {
      function r(c) {
        if (c = a(c), c.length !== t.length) throw new b1("Mismatched type converter count");
        for (var f = 0; f < t.length; ++f) j(t[f], c[f]);
      }
      t.forEach((c) => W1[c] = e);
      var s = Array(e.length), o = [], l = 0;
      e.forEach((c, f) => {
        h1.hasOwnProperty(c) ? s[f] = h1[c] : (o.push(c), f1.hasOwnProperty(c) || (f1[c] = []), f1[c].push(() => {
          s[f] = h1[c], ++l, l === o.length && r(s);
        }));
      }), o.length === 0 && r(s);
    }, C2, A = (t) => {
      for (var e = ""; E[t]; ) e += C2[E[t++]];
      return e;
    }, M;
    function h3(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      var r = e.name;
      if (!t) throw new M(`type "${r}" must have a positive integer typeid pointer`);
      if (h1.hasOwnProperty(t)) {
        if (a.hb) return;
        throw new M(`Cannot register type '${r}' twice`);
      }
      h1[t] = e, delete W1[t], f1.hasOwnProperty(t) && (e = f1[t], delete f1[t], e.forEach((s) => s()));
    }
    function j(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {};
      return h3(t, e, a);
    ...
    }, I2 = (t, e, a) => e === a ? t : a.Ga === void 0 ? null : (t = I2(t, e, a.Ga), t === null ? null : a.$a(t)), S2 = {}, d3 = {}, u3 = (t, e) => {
    ...
    var S1 = (t, e) => Object.defineProperty(e, "name", { value: t }), P2 = (t, e, a) => {
      if (t[e].Ea === void 0) {
        var r = t[e];
        t[e] = function() {
          for (var s = arguments.length, o = new Array(s), l = 0; l < s; l++) o[l] = arguments[l];
          if (!t[e].Ea.hasOwnProperty(o.length)) throw new M(`Function '${a}' called with an invalid number of arguments (${o.length}) - expects one of (${t[e].Ea})!`);
          return t[e].Ea[o.length].apply(this, o);
        }, t[e].Ea = [], t[e].Ea[r.Na] = r;
      }
    }, e2 = (t, e, a) => {
      if (u.hasOwnProperty(t)) {
        if (a === void 0 || u[t].Ea !== void 0 && u[t].Ea[a] !== void 0) throw new M(`Cannot register public name '${t}' twice`);
        if (P2(u, t, t), u[t].Ea.hasOwnProperty(a)) throw new M(`Cannot register multiple overloads of a function with the same number of arguments (${a})!`);
        u[t].Ea[a] = e;
      } else u[t] = e, u[t].Na = a;
    }, c3 = (t) => {
    ...
    function l3(t, e, a, r, s, o, l, c) {
      this.name = t, this.constructor = e, this.Ma = a, this.Ka = r, this.Ga = s, this.bb = o, this.Qa = l, this.$a = c, this.jb = [];
    }
    var i2 = (t, e, a) => {
      for (; e !== a; ) {
        if (!e.Qa) throw new M(`Expected null or instance of ${a.name}, got an instance of ${e.name}`);
        t = e.Qa(t), e = e.Ga;
      }
      return t;
    };
    function _3(t, e) {
      ...
      if (!e.Aa) throw new M(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
    ...
    function f3(t, e) {
      ...
      if (!e || !e.Aa) throw new M(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.Ra && e.Aa.Da.Ra) throw new M(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
      if (a = i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba), this.Sa) {
        if (e.Aa.Fa === void 0) throw new M("Passing raw pointer to smart pointer is illegal");
        switch (this.ob) {
          case 0:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
            else throw new M(`Cannot convert argument of type ${e.Aa.Ha ? e.Aa.Ha.name : e.Aa.Da.name} to parameter type ${this.name}`);
            break;
          case 1:
            a = e.Aa.Fa;
            break;
          case 2:
            if (e.Aa.Ha === this) a = e.Aa.Fa;
              ...
              var r = e.clone();
              a = this.kb(a, B1(() => r.delete())), t !== null && t.push(this.Ka, a);
            }
            break;
          default:
    ...
    function v3(t, e) {
      ...
      if (!e.Aa) throw new M(`Cannot pass "${o2(e)}" as a ${this.name}`);
      if (!e.Aa.Ca) throw new M(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (e.Aa.Da.Ra) throw new M(`Cannot convert argument of type ${e.Aa.Da.name} to parameter type ${this.name}`);
      return i2(e.Aa.Ca, e.Aa.Da.Ba, this.Ba);
    }
    function P1(t, e, a, r, s, o, l, c, f, m, v) {
      this.name = t, this.Ba = e, this.Ta = a, this.Ra = r, this.Sa = s, this.ib = o, this.ob = l, this.Ya = c, this.Ua = f, this.kb = m, this.Ka = v, s || e.Ga !== void 0 ? this.toWireType = f3 : (this.toWireType = r ? _3 : v3, this.Ja = null);
    }
    var E2 = (t, e, a) => {
      if (!u.hasOwnProperty(t)) throw new b1("Replacing nonexistent public symbol");
      u[t].Ea !== void 0 && a !== void 0 ? u[t].Ea[a] = e : (u[t] = e, u[t].Na = a);
    }, $, m3 = function(t, e) {
      let a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : [];
      return t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, u["dynCall_" + t])(e, ...a)) : e = $.get(e)(...a), e;
    }, p3 = (t, e) => function() {
      for (var a = arguments.length, r = new Array(a), s = 0; s < a; s++) r[s] = arguments[s];
      return m3(t, e, r);
    }, F = (t, e) => {
      t = A(t);
      var a = t.includes("j") ? p3(t, e) : $.get(e);
      if (typeof a != "function") throw new M(`unknown function pointer with signature ${t}: ${e}`);
      return a;
    }, O2, A2 = (t) => {
      t = B2(t);
      var e = A(t);
      ...
      function a(o) {
        s[o] || h1[o] || (W1[o] ? W1[o].forEach(a) : (r.push(o), s[o] = true));
      }
      var r = [], s = {};
      throw e.forEach(a), new O2(`${t}: ` + r.map(A2).join([", "]));
    }, n2 = (t, e) => {
    ...
    function a2(t, e, a, r, s) {
      var o = e.length;
      if (2 > o) throw new M("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var l = e[1] !== null && a !== null, c = g3(e), f = e[0].name !== "void", m = o - 2, v = Array(m), y = [], b = [];
      return S1(t, function() {
        for (var U = arguments.length, S = new Array(U), H = 0; H < U; H++) S[H] = arguments[H];
        if (b.length = 0, y.length = l ? 2 : 1, y[0] = s, l) {
          var R = e[1].toWireType(b, this);
          y[1] = R;
        }
        for (var P = 0; P < m; ++P) v[P] = e[P + 2].toWireType(b, S[P]), y.push(v[P]);
        if (S = r(...y), c) Y1(b);
        else for (P = l ? 1 : 2; P < e.length; P++) {
          var T = P === 1 ? R : v[P - 2];
          e[P].Ja !== null && e[P].Ja(T);
        }
    ...
    var k2 = (t) => {
    ...
    }, D2 = { name: "emscripten::val", fromWireType: (t) => {
      var e = v1(t);
      return s2(t), e;
    }, toWireType: (t, e) => B1(e), Ia: 8, readValueFromPointer: C1, Ja: null }, w3 = (t, e, a) => {
      switch (e) {
        case 1:
          return a ? function(r) {
            return this.fromWireType(z[r]);
          } : function(r) {
            return this.fromWireType(E[r]);
          };
        case 2:
          return a ? function(r) {
        ...
        case 4:
          return a ? function(r) {
            return this.fromWireType(L[r >> 2]);
          } : function(r) {
      ...
      var a = h1[t];
      if (a === void 0) throw t = `${e} has unknown type ${A2(t)}`, new M(t);
      return a;
    }, o2 = (t) => {
      ...
      switch (e) {
        ...
        case 8:
          return function(a) {
            return this.fromWireType(w1[a >> 3]);
          };
        default:
      ...
      switch (e) {
        case 1:
          return a ? (r) => z[r] : (r) => E[r];
        case 2:
          return a ? (r) => n1[r >> 1] : (r) => Z[r >> 1];
        case 4:
          return a ? (r) => L[r >> 2] : (r) => C[r >> 2];
        default:
          throw new TypeError(`invalid integer width (${e}): ${t}`);
      }
    }, y3 = Object.assign({ optional: true }, D2), F2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, C3 = (t, e) => {
      for (var a = t >> 1, r = a + e / 2; !(a >= r) && Z[a]; ) ++a;
      if (a <<= 1, 32 < a - t && F2) return F2.decode(E.subarray(t, a));
      for (a = "", r = 0; !(r >= e / 2); ++r) {
        var s = n1[t + 2 * r >> 1];
        if (s == 0) break;
      ...
      var r = [];
      return t = t.toWireType(r, a), r.length && (C[e >> 2] = B1(r)), t;
    }, d2 = [], O3 = (t) => {
      var e = d2.length;
      return d2.push(t), e;
    }, A3 = (t, e) => {
      for (var a = Array(t), r = 0; r < t; ++r) a[r] = z1(C[e + 4 * r >> 2], "parameter " + r);
      return a;
    }, k3 = Reflect.construct, E1 = {}, R2 = (t) => {
      if (!(t instanceof M2 || t == "unwind")) throw t;
    }, W2 = (t) => {
      var e;
      throw _1 = t, X1 || 0 < h2 || ((e = u.onExit) !== null && e !== void 0 && e.call(u, t), l1 = true), new M2(t);
    }, D3 = (t) => {
      if (!l1) try {
        if (t(), !(X1 || 0 < h2)) try {
          _1 = t = _1, W2(t);
      ...
      if (!c2) {
        var t = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: u1 || "./this.program" }, e;
        for (e in u2) u2[e] === void 0 ? delete t[e] : t[e] = u2[e];
        var a = [];
    ...
    b1 = u.InternalError = class extends Error {
      constructor(t) {
        super(t), this.name = "InternalError";
      }
    };
    for (var U2 = Array(256), j1 = 0; 256 > j1; ++j1) U2[j1] = String.fromCharCode(j1);
    C2 = U2, M = u.BindingError = class extends Error {
      constructor(t) {
        super(t), this.name = "BindingError";
      }
    }, Object.assign($1.prototype, { isAliasOf: function(t) {
      if (!(this instanceof $1 && t instanceof $1)) return false;
      ...
      if (this.Aa.Ca || Z1(this), this.Aa.Oa && !this.Aa.Pa) throw new M("Object already scheduled for deletion");
      b2(this);
      var t = this.Aa;
      ...
      function e() {
        return this.Sa ? x1(this.Ba.Ma, { Da: this.ib, Ca: a, Ha: this, Fa: t }) : x1(this.Ba.Ma, { Da: this, Ca: t });
      }
      var a = this.cb(t);
      if (!a) return this.Wa(t), null;
      var r = u3(this.Ba, a);
      if (r !== void 0) return r.Aa.count.value === 0 ? (r.Aa.Ca = a, r.Aa.Fa = t, r.clone()) : (r = r.clone(), this.Wa(t), r);
      if (r = this.Ba.bb(a), r = S2[r], !r) return e.call(this);
      r = this.Ra ? r.Za : r.pointerType;
      var s = I2(a, this.Ba, r.Ba);
      return s === null ? e.call(this) : this.Sa ? x1(r.Ba.Ma, { Da: r, Ca: s, Ha: this, Fa: t }) : x1(r.Ba.Ma, { Da: r, Ca: s });
    } }), O2 = u.UnboundTypeError = ((t, e) => {
...
` + r.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), t1.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), u.count_emval_handles = () => t1.length / 2 - 5 - r2.length;
    var T3 = { c: (t, e, a, r) => D1(`Assertion failed: ${t ? T1(t) : ""}, at: ` + [e ? e ? T1(e) : "" : "unknown filename", a, r ? r ? T1(r) : "" : "unknown function"]), j: (t, e, a) => {
      var r = new o3(t);
      throw C[r.Ca + 16 >> 2] = 0, C[r.Ca + 4 >> 2] = e, C[r.Ca + 8 >> 2] = a, y2 = t, y2;
    }, P: () => {
    }, M: () => {
    }, N: () => {
    }, R: function() {
      ...
      a1([t], o, (l) => {
        ...
        return s.forEach((f, m) => {
          var v = l[m], y = f.eb, b = f.fb, U = l[m + s.length], S = f.lb, H = f.nb;
          c[f.ab] = { read: (R) => v.fromWireType(y(b, R)), write: (R, P) => {
            var T = [];
            S(H, R, U.toWireType(T, P)), Y1(T);
          } };
        }), [{ name: e.name, fromWireType: (f) => {
          var m = {}, v;
          for (v in c) m[v] = c[v].read(f);
          return r(f), m;
        }, toWireType: (f, m) => {
          for (var v in c) if (!(v in m)) throw new TypeError(`Missing field: "${v}"`);
          var y = a();
          for (v in c) c[v].write(y, m[v]);
          return f !== null && f.push(r, y), y;
    ...
    }, k: (t, e, a, r, s, o, l, c, f, m, v, y, b) => {
      v = A(v), o = F(s, o), c && (c = F(l, c)), m && (m = F(f, m)), b = F(y, b);
      var U = c3(v);
      e2(U, function() {
        ...
        S = S1(v, function() {
          if (Object.getPrototypeOf(this) !== P) throw new M("Use 'new' to construct " + v);
          if (T.La === void 0) throw new M(v + " has no accessible constructor");
          for (var N2 = arguments.length, N1 = new Array(N2), G1 = 0; G1 < N2; G1++) N1[G1] = arguments[G1];
          var G2 = T.La[N1.length];
          if (G2 === void 0) throw new M(`Tried to invoke ctor of ${v} with invalid number of parameters (${N1.length}) - expected (${Object.keys(T.La).toString()}) parameters instead!`);
          return G2.apply(this, N1);
        });
        var P = Object.create(R, { constructor: { value: S } });
        S.prototype = P;
        var T = new l3(v, S, P, b, H, o, c, m);
        if (T.Ga) {
          var H2, O1;
          (H2 = (O1 = T.Ga).Va) !== null && H2 !== void 0 || (O1.Va = []), T.Ga.Va.push(T);
        }
        return H = new P1(v, T, true, false, false), O1 = new P1(v + "*", T, false, false, false), R = new P1(v + " const*", T, false, true, false), S2[t] = { pointerType: O1, Za: R }, E2(U, S), [H, O1, R];
      });
    }, r: (t, e, a, r, s, o) => {
      var l = n2(e, a);
      s = F(r, s), a1([], [t], (c) => {
        ...
        if (c.Ba.La === void 0 && (c.Ba.La = []), c.Ba.La[e - 1] !== void 0) throw new M(`Cannot register multiple constructors with identical number of parameters (${e - 1}) for class '${c.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return c.Ba.La[e - 1] = () => {
          U1(`Cannot construct ${c.name} due to unbound types`, l);
        }, a1([], l, (m) => (m.splice(1, 0, null), c.Ba.La[e - 1] = a2(f, m, null, s, o), [])), [];
      });
    }, d: (t, e, a, r, s, o, l, c) => {
      var f = n2(a, r);
      e = A(e), e = k2(e), o = F(s, o), a1([], [t], (m) => {
        function v() {
          U1(`Cannot call ${y} due to unbound types`, f);
        }
        m = m[0];
        var y = `${m.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), c && m.Ba.jb.push(e);
        var b = m.Ba.Ma, U = b[e];
        return U === void 0 || U.Ea === void 0 && U.className !== m.name && U.Na === a - 2 ? (v.Na = a - 2, v.className = m.name, b[e] = v) : (P2(b, e, y), b[e].Ea[a - 2] = v), a1([], f, (S) => (S = a2(y, S, m, o, l), b[e].Ea === void 0 ? (S.Na = a - 2, b[e] = S) : b[e].Ea[a - 2] = S, [])), [];
      });
    }, Y: (t) => j(t, D2), D: (t, e, a, r) => {
      function s() {
      }
      e = A(e), s.values = {}, j(t, { name: e, constructor: s, fromWireType: function(o) {
        return this.constructor.values[o];
      }, toWireType: (o, l) => l.value, Ia: 8, readValueFromPointer: w3(e, a, r), Ja: null }), e2(e, s);
    }, m: (t, e, a) => {
      var r = z1(t, "enum");
      e = A(e), t = r.constructor, r = Object.create(r.constructor.prototype, { value: { value: a }, constructor: { value: S1(`${r.name}_${e}`, function() {
      }) } }), t.values[a] = r, t[e] = r;
    }, A: (t, e, a) => {
      e = A(e), j(t, { name: e, fromWireType: (r) => r, toWireType: (r, s) => s, Ia: 8, readValueFromPointer: M3(e, a), Ja: null });
    }, u: (t, e, a, r, s, o) => {
      var l = n2(e, a);
      t = A(t), t = k2(t), s = F(r, s), e2(t, function() {
        U1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), a1([], l, (c) => (E2(t, a2(t, [c[0], null].concat(c.slice(1)), null, s, o), e - 1), []));
    }, n: (t, e, a, r, s) => {
      if (e = A(e), s === -1 && (s = 4294967295), s = (c) => c, r === 0) {
        var o = 32 - 8 * a;
        s = (c) => c << o >>> o;
      }
      var l = e.includes("unsigned") ? function(c, f) {
        return f >>> 0;
      } : function(c, f) {
        return f;
      };
      j(t, { name: e, fromWireType: s, toWireType: l, Ia: 8, readValueFromPointer: L3(e, a, r !== 0), Ja: null });
    }, g: (t, e, a) => {
      function r(o) {
      ...
      j(t, y3);
    }, v: (t, e, a, r, s, o, l, c, f, m, v, y) => {
      a = A(a), o = F(s, o), c = F(l, c), m = F(f, m), y = F(v, y), a1([t], [e], (b) => (b = b[0], [new P1(a, b.Ba, false, false, true, b, r, o, c, m, y)]));
    }, Z: (t, e) => {
      e = A(e), j(t, { name: e, fromWireType: function(a) {
        for (var r = C[a >> 2], s = a + 4, o, l = s, c = 0; c <= r; ++c) {
          var f = s + c;
          (c == r || E[f] == 0) && (l = l ? T1(l, f - l) : "", o === void 0 ? o = l : (o += "\0", o += l), l = f + 1);
        }
        return e1(a), o;
      }, toWireType: function(a, r) {
        r instanceof ArrayBuffer && (r = new Uint8Array(r));
        var s, o = typeof r == "string";
        if (!(o || r instanceof Uint8Array || r instanceof Uint8ClampedArray || r instanceof Int8Array)) throw new M("Cannot pass non-string to std::string");
        if (o) for (var l = s = 0; l < r.length; ++l) {
          var c = r.charCodeAt(l);
          127 >= c ? s++ : 2047 >= c ? s += 2 : 55296 <= c && 57343 >= c ? (s += 4, ++l) : s += 3;
        }
        else s = r.length;
        if (l = l2(4 + s + 1), c = l + 4, C[l >> 2] = s, o) y1(r, c, s + 1);
        else if (o) for (o = 0; o < s; ++o) {
          var f = r.charCodeAt(o);
          if (255 < f) throw e1(c), new M("String has UTF-16 code units that do not fit in 8 bits");
          E[c + o] = f;
        }
        else for (o = 0; o < s; ++o) E[c + o] = r[o];
        return a !== null && a.push(e1, l), l;
      }, Ia: 8, readValueFromPointer: C1, Ja(a) {
        e1(a);
      } });
    }, y: (t, e, a) => {
      if (a = A(a), e === 2) var r = C3, s = b3, o = I3, l = (c) => Z[c >> 1];
      else e === 4 && (r = S3, s = P3, o = E3, l = (c) => C[c >> 2]);
      j(t, { name: a, fromWireType: (c) => {
        for (var f = C[c >> 2], m, v = c + 4, y = 0; y <= f; ++y) {
          var b = c + 4 + y * e;
          (y == f || l(b) == 0) && (v = r(v, b - v), m === void 0 ? m = v : (m += "\0", m += v), v = b + e);
        }
        return e1(c), m;
      }, toWireType: (c, f) => {
        if (typeof f != "string") throw new M(`Cannot pass non-string to C++ string type ${a}`);
        var m = o(f), v = l2(4 + m + e);
        return C[v >> 2] = m / e, s(f, v + 4, m + e), c !== null && c.push(e1, v), v;
      }, Ia: 8, readValueFromPointer: C1, Ja(c) {
        e1(c);
      } });
    }, x: (t, e, a, r, s, o) => {
      R1[t] = { name: A(e), Ua: F(a, r), Ka: F(s, o), Xa: [] };
    }, i: (t, e, a, r, s, o, l, c, f, m) => {
      R1[t].Xa.push({ ab: A(e), gb: a, eb: F(r, s), fb: o, mb: l, lb: F(c, f), nb: m });
    }, $: (t, e) => {
      ...
      throw 1 / 0;
    }, C: (t, e, a) => (t = v1(t), e = z1(e, "emval::as"), T2(e, a, t)), q: (t, e, a, r) => (t = d2[t], e = v1(e), t(null, e, a, r)), W: s2, E: (t, e) => (t = v1(t), e = v1(e), t == e), p: (t, e, a) => {
      var r = A3(t, e), s = r.shift();
      t--;
      var o = Array(t);
      return e = `methodCaller<(${r.map((l) => l.name).join(", ")}) => ${s.name}>`, O3(S1(e, (l, c, f, m) => {
        for (var v = 0, y = 0; y < t; ++y) o[y] = r[y].readValueFromPointer(m + v), v += r[y].Ia;
        return l = a === 1 ? k3(c, o) : c.apply(l, o), T2(s, f, l);
      }));
    }, z: (t) => {
      9 < t && (t1[t + 1] += 1);
    }, ca: (t) => {
      var e = v1(t);
      Y1(e), s2(t);
    }, s: (t, e) => (t = z1(t, "_emval_take_value"), t = t.readValueFromPointer(e), B1(t)), G: (t, e) => {
      if (E1[t] && (clearTimeout(E1[t].id), delete E1[t]), !e) return 0;
      var a = setTimeout(() => {
        delete E1[t], D3(() => z2(t, performance.now()));
      }, e);
      return E1[t] = { id: a, qb: e }, 0;
    }, H: (t, e, a, r) => {
      var s = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(s, 0, 1).getTimezoneOffset();
      s = new Date(s, 6, 1).getTimezoneOffset(), C[t >> 2] = 60 * Math.max(o, s), L[e >> 2] = +(o != s), e = (l) => {
        var c = Math.abs(l);
        return `UTC${0 <= l ? "-" : "+"}${String(Math.floor(c / 60)).padStart(2, "0")}${String(c % 60).padStart(2, "0")}`;
    ...
    }, S: () => 52, Q: () => 52, l: R3, f: U3, e: j3, B: W3, aa: z3, a: x3, b: B3, h: $3, t: H3, U: W2, L: (t, e) => ($2(E.subarray(t, t + e)), 0) }, I;
    (async function(t, e) {
      function a(o) {
        var l;
        return I = o.exports, K = I.da, s1(), $ = I.ga, x.unshift(I.ea), o1--, (l = u.monitorRunDependencies) === null || l === void 0 || l.call(u, o1), o1 == 0 && L1 && (o = L1, L1 = null, o()), I;
      }
      o1++, (t = u.monitorRunDependencies) === null || t === void 0 || t.call(u, o1);
      var r = { a: T3 };
      if (u.instantiateWasm) try {
        return u.instantiateWasm(r, a);
      } catch (o) {
        q(`Module.instantiateWasm callback failed with error: ${o}`), V(o);
      }
      (e = F1) !== null && e !== void 0 || (F1 = w2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : u.locateFile ? u.locateFile("DotLottiePlayer.wasm", D) : D + "DotLottiePlayer.wasm");
      try {
        var s = await s3(r);
    ...
    var l2 = (t) => (l2 = I.fa)(t), e1 = (t) => (e1 = I.ha)(t), B2 = (t) => (B2 = I.ia)(t), z2 = (t, e) => (z2 = I.ja)(t, e), Q = (t, e) => (Q = I.ka)(t, e), X = (t) => (X = I.la)(t), Y = () => (Y = I.ma)();
    u.dynCall_jiii = (t, e, a, r) => (u.dynCall_jiii = I.na)(t, e, a, r), u.dynCall_jii = (t, e, a) => (u.dynCall_jii = I.oa)(t, e, a), u.dynCall_vjii = (t, e, a, r, s) => (u.dynCall_vjii = I.pa)(t, e, a, r, s), u.dynCall_vjfii = (t, e, a, r, s, o) => (u.dynCall_vjfii = I.qa)(t, e, a, r, s, o), u.dynCall_vjiii = (t, e, a, r, s, o) => (u.dynCall_vjiii = I.ra)(t, e, a, r, s, o), u.dynCall_vj = (t, e, a) => (u.dynCall_vj = I.sa)(t, e, a), u.dynCall_vjiiiii = (t, e, a, r, s, o, l, c) => (u.dynCall_vjiiiii = I.ta)(t, e, a, r, s, o, l, c), u.dynCall_vjiffii = (t, e, a, r, s, o, l, c) => (u.dynCall_vjiffii = I.ua)(t, e, a, r, s, o, l, c), u.dynCall_vjiiii = (t, e, a, r, s, o, l) => (u.dynCall_vjiiii = I.va)(t, e, a, r, s, o, l), u.dynCall_viijii = (t, e, a, r, s, o, l) => (u.dynCall_viijii = I.wa)(t, e, a, r, s, o, l), u.dynCall_iiiiij = (t, e, a, r, s, o, l) => (u.dynCall_iiiiij = I.xa)(t, e, a, r, s, o, l), u.dynCall_iiiiijj = (t, e, a, r, s, o, l, c, f) => (u.dynCall_iiiiijj = I.ya)(t, e, a, r, s, o, l, c, f), u.dynCall_iiiiiijj = (t, e, a, r, s, o, l, c, f, m) => (u.dynCall_iiiiiijj = I.za)(t, e, a, r, s, o, l, c, f, m);
    function R3(t, e) {
      var a = Y();
      try {
        return $.get(t)(e);
      } catch (r) {
        if (X(a), r !== r + 0) throw r;
        Q(1, 0);
      }
    }
    function W3(t, e, a, r, s, o) {
      var l = Y();
      try {
        return $.get(t)(e, a, r, s, o);
      } catch (c) {
        if (X(l), c !== c + 0) throw c;
        Q(1, 0);
      }
    }
    function x3(t, e) {
    ...
    function H3(t, e, a, r, s) {
      var o = Y();
      try {
        $.get(t)(e, a, r, s);
      } catch (l) {
        if (X(o), l !== l + 0) throw l;
        Q(1, 0);
      }
    }
    var H1;
    ...
    function j2() {
      function t() {
        if (!H1 && (H1 = true, u.calledRun = true, !l1)) {
          var e;
          if (Q1(x), W(u), (e = u.onRuntimeInitialized) === null || e === void 0 || e.call(u), u.postRun) for (typeof u.postRun == "function" && (u.postRun = [u.postRun]); u.postRun.length; ) {
            var a = u.postRun.shift();
            M1.unshift(a);
          }
          Q1(M1);
        }
      ...
      if (!(0 < o1)) {
        if (u.preRun) for (typeof u.preRun == "function" && (u.preRun = [u.preRun]); u.preRun.length; ) n3();
        Q1(k1), 0 < o1 || (u.setStatus ? (u.setStatus("Running..."), setTimeout(() => {
          setTimeout(() => u.setStatus(""), 1), t();
        }, 1)) : t());
      }
    }
    if (u.preInit) for (typeof u.preInit == "function" && (u.preInit = [u.preInit]); 0 < u.preInit.length; ) u.preInit.pop()();
    return j2(), n = J, n;
  };
})();
var Z3 = Y3;
...
p(A1, "_ModulePromise", null), p(A1, "_wasmURL", `https://cdn.jsdelivr.net/npm/${Y2}@${X2}/dist/dotlottie-player.wasm`);
var Z2 = class {
  constructor() {
  ...
  dispatch(h) {
    var _a;
    (_a = this._eventListeners.get(h.type)) == null ? void 0 : _a.forEach((i) => i(h));
  }
...
var N = class {
  static _initializeObserver() {
    ...
    let h = (i) => {
      i.forEach((n) => {
        let d = this._observedCanvases.get(n.target);
        d && (n.isIntersecting ? d.unfreeze() : d.freeze());
      });
    };
  ...
  static observe(h, i) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, i), (_a = this._observer) == null ? void 0 : _a.observe(h));
  }
  static unobserve(h) {
    var _a, _b;
    (_a = this._observer) == null ? void 0 : _a.unobserve(h), this._observedCanvases.delete(h), this._observedCanvases.size === 0 && ((_b = this._observer) == null ? void 0 : _b.disconnect(), this._observer = null);
  }
};
p(N, "_observer", null), p(N, "_observedCanvases", /* @__PURE__ */ new Map());
var G = class {
  static _initializeObserver() {
    if (this._observer) return;
    let h = (i) => {
      i.forEach((n) => {
        ...
        this._observedCanvases.set(n.target, [_, u]);
      });
    };
  ...
  static observe(h, i) {
    var _a;
    this._initializeObserver(), !this._observedCanvases.has(h) && (this._observedCanvases.set(h, [i, 0]), (_a = this._observer) == null ? void 0 : _a.observe(h));
  }
  static unobserve(h) {
    var _a;
    ...
    (_a = this._observer) == null ? void 0 : _a.unobserve(h), this._observedCanvases.delete(h), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
p(G, "_observer", null), p(G, "_observedCanvases", /* @__PURE__ */ new Map());
function t0(h) {
...
function J2(h) {
  return K3.every((i) => Object.prototype.hasOwnProperty.call(h, i));
}
function q2(h) {
  if (typeof h == "string") try {
    return J2(JSON.parse(h));
  } catch {
    return false;
  }
  else return J2(h);
...
function d1() {
  return 1 + ((O ? window.devicePixelRatio : 1) - 1) * Q3;
}
function m1(h) {
  let i = h.getBoundingClientRect(), n = window.innerHeight || document.documentElement.clientHeight, d = window.innerWidth || document.documentElement.clientWidth;
  return !(i.bottom < 0 || i.top > n || i.right < 0 || i.left > d);
}
function B(h) {
  let i = h.target;
  if (i instanceof HTMLCanvasElement) {
    ...
    let d = i.width / n.width, _ = i.height / n.height, w = (h.clientX - n.left) * d, u = (h.clientY - n.top) * _;
    return !Number.isFinite(w) || !Number.isFinite(u) || Number.isNaN(w) || Number.isNaN(u) ? null : { x: w, y: u };
  }
  return null;
}
function t3(h) {
  let i = h.replace("OpenUrl: ", ""), n = i.indexOf(" | Target: "), d, _;
  n === -1 ? (d = i, _ = "_blank") : (d = i.substring(0, n), _ = i.substring(n + 11)), window.open(d, _);
}
var K2 = (h, i) => {
  let n = new h.VectorChar(), d = new Uint8Array(i);
  for (let _ = 0; _ < d.length; _ += 1) {
    let w = d[_];
    w !== void 0 && typeof w == "number" && n.push_back(w);
  }
  return n;
};
var f2 = (h, i) => h === "reverse" ? i.Mode.Reverse : h === "bounce" ? i.Mode.Bounce : h === "reverse-bounce" ? i.Mode.ReverseBounce : i.Mode.Forward;
var i0 = (h, i) => h === "contain" ? i.Fit.Contain : h === "cover" ? i.Fit.Cover : h === "fill" ? i.Fit.Fill : h === "fit-height" ? i.Fit.FitHeight : h === "fit-width" ? i.Fit.FitWidth : i.Fit.None;
var n0 = (h, i) => {
...
var e3 = class g {
  constructor(i) {
    ...
    p(this, "_canvas"), p(this, "_context", null), p(this, "_eventManager"), p(this, "_animationFrameId", null), p(this, "_frameManager"), p(this, "_dotLottieCore", null), p(this, "_stateMachineId", ""), p(this, "_stateMachineConfig", null), p(this, "_isStateMachineRunning", false), p(this, "_stateMachineObserverHandle", null), p(this, "_stateMachineInternalMessageObserver", null), p(this, "_dotLottieObserverHandle", null), p(this, "_renderConfig", {}), p(this, "_isFrozen", false), p(this, "_backgroundColor", null), p(this, "_boundOnClick", null), p(this, "_boundOnPointerUp", null), p(this, "_boundOnPointerDown", null), p(this, "_boundOnPointerMove", null), p(this, "_boundOnPointerEnter", null), p(this, "_boundOnPointerLeave", null), p(this, "_bufferMismatchCount", 0), p(this, "_lastExpectedBufferSize", 0), this._canvas = i.canvas, this._eventManager = new Z2(), this._frameManager = new q3(), this._renderConfig = { ...i.renderConfig, devicePixelRatio: ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || d1(), freezeOnOffscreen: ((_b = i.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true }, A1.load().then((n) => {
      ...
      }), this._dotLottieCore = new n.DotLottiePlayer({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", n), segment: v2(i.segment ?? [], n), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: m2(i.layout, n) }), this._stateMachineId = i.stateMachineId ?? "", this._stateMachineConfig = i.stateMachineConfig ?? null, this._dotLottieObserverHandle = this._dotLottieCore.subscribe(d), this._eventManager.dispatch({ type: "ready" }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), i.backgroundColor && this.setBackgroundColor(i.backgroundColor);
    }).catch((n) => {
  ...
  async _fetchData(i) {
    ...
    return V2(d) ? d : new TextDecoder().decode(d);
  }
  _loadFromData(i) {
    if (this._dotLottieCore === null || g._wasmModule === null) return;
    let n = this._canvas.width, d = this._canvas.height, _ = false;
    if (typeof i == "string") {
      if (!q2(i)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      _ = this._dotLottieCore.loadAnimationData(i, n, d);
      ...
      _ = this._dotLottieCore.loadDotLottieData(K2(g._wasmModule, i), n, d);
    } else if (typeof i == "object") {
      if (!q2(i)) {
        this._dispatchError("Invalid Lottie JSON object: The provided object does not conform to the Lottie JSON format.");
        return;
      }
      _ = this._dotLottieCore.loadAnimationData(JSON.stringify(i), n, d);
    } else {
  ...
  get layout() {
    var _a;
    let i = (_a = this._dotLottieCore) == null ? void 0 : _a.config().layout;
    if (i) return { align: [i.align.get(0), i.align.get(1)], fit: (() => {
      var _a2, _b, _c, _d, _e, _f;
      switch (i.fit) {
        case ((_a2 = g._wasmModule) == null ? void 0 : _a2.Fit.Contain):
          return "contain";
        case ((_b = g._wasmModule) == null ? void 0 : _b.Fit.Cover):
          return "cover";
        case ((_c = g._wasmModule) == null ? void 0 : _c.Fit.Fill):
          return "fill";
        case ((_d = g._wasmModule) == null ? void 0 : _d.Fit.FitHeight):
          return "fit-height";
        case ((_e = g._wasmModule) == null ? void 0 : _e.Fit.FitWidth):
          return "fit-width";
        case ((_f = g._wasmModule) == null ? void 0 : _f.Fit.None):
          return "none";
        default:
          return "contain";
      }
  ...
  get manifest() {
    var _a;
    try {
      let i = (_a = this._dotLottieCore) == null ? void 0 : _a.manifestString();
  ...
  get segment() {
    var _a;
    let i = (_a = this._dotLottieCore) == null ? void 0 : _a.config().segment;
  ...
  get mode() {
    var _a, _b, _c, _d;
    let i = (_a = this._dotLottieCore) == null ? void 0 : _a.config().mode;
    return i === ((_b = g._wasmModule) == null ? void 0 : _b.Mode.Reverse) ? "reverse" : i === ((_c = g._wasmModule) == null ? void 0 : _c.Mode.Bounce) ? "bounce" : i === ((_d = g._wasmModule) == null ? void 0 : _d.Mode.ReverseBounce) ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(i) {
    this._dotLottieCore === null || g._wasmModule === null || (this._stopAnimationLoop(), O && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas), this._cleanupStateMachineListeners()), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: i.animationId ?? "", themeId: i.themeId ?? "", stateMachineId: "", autoplay: i.autoplay ?? false, backgroundColor: 0, loopAnimation: i.loop ?? false, loopCount: i.loopCount ?? 0, mode: f2(i.mode ?? "forward", g._wasmModule), segment: v2(i.segment ?? [], g._wasmModule), speed: i.speed ?? 1, useFrameInterpolation: i.useFrameInterpolation ?? true, marker: i.marker ?? "", layout: m2(i.layout, g._wasmModule) }), i.data ? this._loadFromData(i.data) : i.src && this._loadFromSrc(i.src), this.setBackgroundColor(i.backgroundColor ?? ""));
  }
  _draw() {
    if (this._dotLottieCore !== null && (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (this._context = this._canvas.getContext("2d")), this._context)) {
      ...
      if (i.byteLength !== n) {
        this._lastExpectedBufferSize === n ? this._bufferMismatchCount += 1 : (this._bufferMismatchCount = 1, this._lastExpectedBufferSize = n), this._bufferMismatchCount === 10 && console.warn(`[dotlottie-web] Persistent buffer size mismatch detected. Expected ${n} bytes for canvas ${this._canvas.width}x${this._canvas.height}, but got ${i.byteLength} bytes. This may indicate a WASM memory allocation issue or invalid canvas dimensions.`);
        return;
      }
      this._bufferMismatchCount = 0, this._lastExpectedBufferSize = n;
      let d = null, _ = new Uint8ClampedArray(i, 0, i.byteLength);
      typeof ImageData > "u" ? (d = this._context.createImageData(this._canvas.width, this._canvas.height), d.data.set(_)) : d = new ImageData(_, this._canvas.width, this._canvas.height), this._context.putImageData(d, 0, 0);
    }
  }
  _stopAnimationLoop() {
  ...
  play() {
    this._dotLottieCore === null || !this.isLoaded || (this._stopAnimationLoop(), (this._dotLottieCore.play() || this._dotLottieCore.isPlaying()) && (this._isFrozen = false, this._startAnimationLoop()), O && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !m1(this._canvas) && this.freeze());
  }
  pause() {
  ...
  setBackgroundColor(i) {
    this._dotLottieCore !== null && (O && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = i : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: e0(i) }), this._backgroundColor = i);
  }
  setLoop(i) {
  ...
  destroy() {
    var _a, _b, _c, _d;
    this._stopAnimationLoop(), this._isStateMachineRunning = false, O && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)), this._stateMachineObserverHandle && ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && ((_b = this._dotLottieCore) == null ? void 0 : _b.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null), this._dotLottieObserverHandle && ((_c = this._dotLottieCore) == null ? void 0 : _c.unsubscribe(this._dotLottieObserverHandle), this._dotLottieObserverHandle.delete(), this._dotLottieObserverHandle = null), (_d = this._dotLottieCore) == null ? void 0 : _d.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    if (!(!this._dotLottieCore || !this.isLoaded)) {
      if (O && this._canvas instanceof HTMLCanvasElement) {
        let i = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: n, width: d } = this._canvas.getBoundingClientRect();
        n !== 0 && d !== 0 && (this._canvas.width = d * i, this._canvas.height = n * i);
      }
      this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && (this._dotLottieCore.render(), this._draw());
    }
  }
  setTransform(i) {
    if (!this._dotLottieCore || !g._wasmModule) return false;
    let n = new g._wasmModule.VectorFloat();
    for (let _ of i) n.push_back(_);
    let d = this._dotLottieCore.setTransform(n);
    return d && this._dotLottieCore.render() && this._draw(), d;
  }
  getTransform() {
    if (!this._dotLottieCore) return;
    let i = [0, 0, 0, 0, 0, 0, 0, 0, 0], n = this._dotLottieCore.getTransform();
    for (let d = 0; d < n.size(); d += 1) i[d] = n.get(d);
    return i;
  }
  setSegment(i, n) {
    this._dotLottieCore === null || g._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: v2([i, n], g._wasmModule) });
  }
  setMode(i) {
    this._dotLottieCore === null || g._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: f2(i, g._wasmModule) });
  }
  setRenderConfig(i) {
    let { devicePixelRatio: n, freezeOnOffscreen: d, quality: _, ...w } = i;
    this._renderConfig = { ...this._renderConfig, ...w, devicePixelRatio: n || d1(), freezeOnOffscreen: d ?? true, ..._ !== void 0 && { quality: _ } }, _ !== void 0 && this._dotLottieCore && this._dotLottieCore.setQuality(_), O && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), m1(this._canvas) || this.freeze()) : (N.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(i) {
  ...
  markers() {
    var _a;
    let i = (_a = this._dotLottieCore) == null ? void 0 : _a.markers();
    if (i) {
      let n = [];
  ...
  setLayout(i) {
    this._dotLottieCore === null || g._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: m2(i, g._wasmModule) });
  }
  setViewport(i, n, d, _) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(i, n, d, _);
  }
  static setWasmUrl(i) {
    A1.setWasmUrl(i);
  }
  static async registerFont(i, n) {
    try {
      let d = await A1.load(), _;
      if (typeof n == "string") {
        let u = await fetch(n);
        if (!u.ok) return console.error(`Failed to fetch font from URL: ${n}. Status: ${u.status}`), false;
        _ = await u.arrayBuffer();
      } else if (n instanceof Uint8Array) {
        let u = n.buffer.slice(n.byteOffset, n.byteOffset + n.byteLength);
        u instanceof ArrayBuffer ? _ = u : (_ = new ArrayBuffer(n.byteLength), new Uint8Array(_).set(n));
      } else _ = n;
      let w = d.registerFont(i, K2(d, _));
      return w || console.error(`Failed to register font "${i}". Font data may be invalid.`), w;
    } catch (d) {
      return console.error(`Error registering font "${i}":`, d), false;
    }
  }
  tween(i, n) {
    var _a;
    if (!g._wasmModule) return false;
    let d = [0, 0, 1, 1], _ = new g._wasmModule.VectorFloat();
    for (let w of d) _.push_back(w);
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tween(i, n, _)) ?? false;
  }
  tweenToMarker(i, n) {
    var _a;
    if (!g._wasmModule) return false;
    let d = [0, 0, 1, 1], _ = new g._wasmModule.VectorFloat();
    for (let w of d) _.push_back(w);
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.tweenToMarker(i, n, _)) ?? false;
  }
  animationSize() {
    var _a, _b;
    let i = ((_a = this._dotLottieCore) == null ? void 0 : _a.animationSize().get(0)) ?? 0, n = ((_b = this._dotLottieCore) == null ? void 0 : _b.animationSize().get(1)) ?? 0;
    return { width: i, height: n };
  }
  getLayerBoundingBox(i) {
    var _a;
    let n = (_a = this._dotLottieCore) == null ? void 0 : _a.getLayerBounds(i);
    if (!n || n.size() !== 8) return;
    let d = [];
    for (let _ = 0; _ < 8; _ += 1) d.push(n.get(_));
    return d;
  }
  static transformThemeToLottieSlots(i, n) {
    var _a;
    return ((_a = g._wasmModule) == null ? void 0 : _a.transformThemeToLottieSlots(i, n)) ?? "";
  }
  _setupStateMachineObservers() {
    if (!this._dotLottieCore || !g._wasmModule) return;
    let i = new g._wasmModule.CallbackStateMachineObserver();
    i.setOnStart(() => {
      setTimeout(() => {
      ...
      setTimeout(() => {
        var _a;
        this._isStateMachineRunning = false, this._eventManager.dispatch({ type: "stateMachineStop" }), ((_a = this._dotLottieCore) == null ? void 0 : _a.isPlaying()) || this._stopAnimationLoop();
      }, 0);
    }), i.setOnCustomEvent((d) => {
      this._eventManager.dispatch({ type: "stateMachineCustomEvent", eventName: d });
    }), i.setOnBooleanInputValueChange((d, _, w) => {
      this._eventManager.dispatch({ type: "stateMachineBooleanInputValueChange", inputName: d, newValue: w, oldValue: _ });
    }), i.setOnNumericInputValueChange((d, _, w) => {
      this._eventManager.dispatch({ type: "stateMachineNumericInputValueChange", inputName: d, newValue: w, oldValue: _ });
    }), i.setOnStringInputValueChange((d, _, w) => {
      this._eventManager.dispatch({ type: "stateMachineStringInputValueChange", inputName: d, newValue: w, oldValue: _ });
    }), i.setOnInputFired((d) => {
      this._eventManager.dispatch({ type: "stateMachineInputFired", inputName: d });
    }), i.setOnTransition((d, _) => {
      this._eventManager.dispatch({ type: "stateMachineTransition", fromState: d, toState: _ });
    }), i.setOnStateEntered((d) => {
      this._eventManager.dispatch({ type: "stateMachineStateEntered", state: d });
    }), i.setOnStateExit((d) => {
      this._eventManager.dispatch({ type: "stateMachineStateExit", state: d });
    }), i.setOnError((d) => {
      this._eventManager.dispatch({ type: "stateMachineError", error: d });
    });
    let n = new g._wasmModule.CallbackStateMachineInternalObserver();
    n.setOnMessage((d) => {
      O ? d.startsWith("OpenUrl: ") && t3(d) : this._eventManager.dispatch({ type: "stateMachineInternalMessage", message: d });
  ...
  _cleanupStateMachineObservers() {
    var _a, _b;
    this._stateMachineObserverHandle && ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineUnsubscribe(this._stateMachineObserverHandle), this._stateMachineObserverHandle.delete(), this._stateMachineObserverHandle = null), this._stateMachineInternalMessageObserver && ((_b = this._dotLottieCore) == null ? void 0 : _b.stateMachineInternalUnsubscribe(this._stateMachineInternalMessageObserver), this._stateMachineInternalMessageObserver.delete(), this._stateMachineInternalMessageObserver = null);
  }
  stateMachineLoad(i) {
    if (!this._dotLottieCore || !g._wasmModule) return false;
  ...
  stateMachineStart() {
    if (g._wasmModule === null || this._dotLottieCore === null) return false;
    let i = g._wasmModule.createDefaultOpenUrlPolicy();
    if (this._stateMachineConfig) {
      let d = this._stateMachineConfig.openUrlPolicy;
      if (d && typeof d.requireUserInteraction == "boolean" && (i.requireUserInteraction = d.requireUserInteraction), d == null ? void 0 : d.whitelist) {
        i.whitelist = new g._wasmModule.VectorString();
        for (let _ of d.whitelist) i.whitelist.push_back(_);
      }
    }
  ...
  stateMachineGetStatus() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineStatus()) ?? "";
  }
  stateMachineGetCurrentState() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineCurrentState()) ?? "";
  }
  stateMachineGetActiveId() {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.activeStateMachineId()) ?? "";
  }
  stateMachineOverrideState(i, n = false) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineOverrideCurrentState(i, n)) ?? false;
  }
  stateMachineGet(i) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.getStateMachine(i)) ?? "";
  }
  stateMachineGetListeners() {
    if (!this._dotLottieCore) return [];
    let i = this._dotLottieCore.stateMachineFrameworkSetup(), n = [];
    for (let d = 0; d < i.size(); d += 1) n.push(i.get(d));
    return n;
  }
  stateMachineSetBooleanInput(i, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetBooleanInput(i, n)) ?? false;
  }
  stateMachineSetNumericInput(i, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetNumericInput(i, n)) ?? false;
  }
  stateMachineSetStringInput(i, n) {
    var _a;
    return ((_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineSetStringInput(i, n)) ?? false;
  }
  stateMachineGetBooleanInput(i) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetBooleanInput(i);
  }
  stateMachineGetNumericInput(i) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetNumericInput(i);
  }
  stateMachineGetStringInput(i) {
    var _a;
    return (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineGetStringInput(i);
  }
  ...
  stateMachineFireEvent(i) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachineFireEvent(i);
  }
  stateMachinePostClickEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostClickEvent(i, n);
  }
  stateMachinePostPointerUpEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerUpEvent(i, n);
  }
  stateMachinePostPointerDownEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerDownEvent(i, n);
  }
  stateMachinePostPointerMoveEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerMoveEvent(i, n);
  }
  stateMachinePostPointerEnterEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerEnterEvent(i, n);
  }
  stateMachinePostPointerExitEvent(i, n) {
    var _a;
    (_a = this._dotLottieCore) == null ? void 0 : _a.stateMachinePostPointerExitEvent(i, n);
  }
  _onClick(i) {
    let n = B(i);
  ...
  _setupStateMachineListeners() {
    if (O && this._canvas instanceof HTMLCanvasElement && this._dotLottieCore !== null && this.isLoaded) {
...
var s0 = class {
  ...
  getWorker(h) {
    return this._workers.has(h) || this._workers.set(h, new r0()), this._workers.get(h);
  }
...
function Q2(h, i) {
  if (h instanceof HTMLCanvasElement) {
    let { height: n, width: d } = h.getBoundingClientRect();
    if (n !== 0 && d !== 0) return { width: d * i, height: n * i };
  }
...
var g2 = class r1 {
  ...
  async _create(i) {
    ...
    let { instanceId: d } = await this._sendMessage("create", { instanceId: this._id, config: { ...i, canvas: n }, ...Q2(this._canvas, ((_a = i.renderConfig) == null ? void 0 : _a.devicePixelRatio) || d1()) }, [n]);
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), O && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !m1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setRenderConfig(i) {
    ...
    let { devicePixelRatio: n, freezeOnOffscreen: d, quality: _, ...w } = i;
    await this._sendMessage("setRenderConfig", { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...w, devicePixelRatio: n || d1(), freezeOnOffscreen: d ?? true, ..._ !== void 0 && { quality: _ } } }), await this._updateDotLottieInstanceState(), O && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? G.observe(this._canvas, this) : G.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (N.observe(this._canvas, this), m1(this._canvas) || await this.freeze()) : (N.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  ...
  async resize() {
    if (!this._created) return;
    let { height: i, width: n } = Q2(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || d1());
    await this._sendMessage("resize", { height: i, instanceId: this._id, width: n }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), r1._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), O && this._canvas instanceof HTMLCanvasElement && (N.unobserve(this._canvas), G.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setViewport(i, n, d, _) {
    return this._created ? this._sendMessage("setViewport", { x: i, y: n, width: d, height: _, instanceId: this._id }) : false;
  }
  async animationSize() {
  ...
  async _sendMessage(i, n, d) {
    let _ = { id: `dotlottie-request-${p2()}`, method: i, params: n };
    return this._worker.postMessage(_, d || []), new Promise((w, u) => {
      let W = (V) => {
        let J = V.data;
        J.id === _.id && (this._worker.removeEventListener("message", W), J.error ? u(new Error(`Failed to execute method ${i}: ${J.error}`)) : w(J.result));
      };
  ...
  static async registerFont(i, n) {
    try {
      let d = p2();
      return r1._workerManager.broadcastMessage({ id: d, method: "registerFont", params: { fontName: i, fontSource: n } }), true;
    } catch (d) {
      return console.error(`Error broadcasting registerFont for "${i}":`, d), false;
    }
  }
  ...
  async _setupStateMachineListeners() {
    if (O && this._canvas instanceof HTMLCanvasElement && this.isLoaded) {
...
p(g2, "_workerManager", new s0()), p(g2, "_wasmUrl", "");
var J1 = g2;
var K1 = ({ animationId: h, autoplay: i, backgroundColor: n, className: d, createDotLottie: _, data: w, dotLottieRefCallback: u, layout: W, loop: V, mode: J, playOnHover: p1, renderConfig: u1, segment: D, speed: c1, src: q, stateMachineConfig: i1, stateMachineId: K, style: l1, themeData: _1, themeId: z, useFrameInterpolation: E, workerId: n1, ...Z }) => {
  let L = (0, import_react.useRef)(null), C = (0, import_react.useRef)(null), g1 = (0, import_react.useRef)(u), w1 = { speed: c1, mode: J, loop: V, useFrameInterpolation: E, segment: D, backgroundColor: n, autoplay: i, themeId: z, workerId: n1, src: q, data: w, layout: W, renderConfig: u1, animationId: h, stateMachineConfig: i1, stateMachineId: K }, s1 = (0, import_react.useRef)(w1);
  g1.current = u, s1.current = w1;
  let k1 = (0, import_react.useCallback)((x) => {
    var _a, _b;
    C.current = x, x ? L.current = _({ ...s1.current, canvas: x }) : ((_a = L.current) == null ? void 0 : _a.destroy(), L.current = null), (_b = g1.current) == null ? void 0 : _b.call(g1, L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    var _a, _b;
    let x = (M1) => {
      var _a2, _b2;
      p1 && (M1.type === "mouseenter" && ((_a2 = L.current) == null ? void 0 : _a2.play()), M1.type === "mouseleave" && ((_b2 = L.current) == null ? void 0 : _b2.pause()));
    };
    return (_a = C.current) == null ? void 0 : _a.addEventListener("mouseenter", x), (_b = C.current) == null ? void 0 : _b.addEventListener("mouseleave", x), () => {
      var _a2, _b2;
      (_a2 = C.current) == null ? void 0 : _a2.removeEventListener("mouseenter", x), (_b2 = C.current) == null ? void 0 : _b2.removeEventListener("mouseleave", x);
    };
  }, [p1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setSpeed(c1 ?? 1);
  }, [c1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setMode(J ?? "forward");
  }, [J]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setLoop(V ?? false);
  }, [V]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setUseFrameInterpolation(E ?? true);
  }, [E]), (0, import_react.useEffect)(() => {
    var _a;
    typeof (D == null ? void 0 : D[0]) == "number" && typeof D[1] == "number" && ((_a = L.current) == null ? void 0 : _a.setSegment(D[0], D[1]));
  }, [D]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setBackgroundColor(n ?? "");
  }, [n]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setRenderConfig(u1 ?? {});
  }, [JSON.stringify(u1)]), (0, import_react.useEffect)(() => {
    var _a;
    typeof w != "string" && typeof w != "object" || ((_a = L.current) == null ? void 0 : _a.load({ data: w, ...s1.current }));
  }, [w]), (0, import_react.useEffect)(() => {
    var _a;
    typeof q == "string" && ((_a = L.current) == null ? void 0 : _a.load({ src: q, ...s1.current }));
  }, [q]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setMarker(Z.marker ?? "");
  }, [Z.marker]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.loadAnimation(h ?? "");
  }, [h]), (0, import_react.useEffect)(() => {
    var _a;
    typeof z == "string" && ((_a = L.current) == null ? void 0 : _a.setTheme(z));
  }, [z]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setThemeData(_1 ?? "");
  }, [_1]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.setLayout(W ?? {});
  }, [W == null ? void 0 : W.fit, (W == null ? void 0 : W.align) && W.align[0], (W == null ? void 0 : W.align) && W.align[1]]), (0, import_react.useEffect)(() => {
    var _a;
    ((_a = L.current) == null ? void 0 : _a.isLoaded) && (typeof K == "string" && K ? L.current.stateMachineLoad(K) && L.current.stateMachineStart() : L.current.stateMachineStop());
  }, [K]), (0, import_react.useEffect)(() => {
    var _a;
    (_a = L.current) == null ? void 0 : _a.stateMachineSetConfig(i1 ?? null);
  }, [i1]), (0, import_jsx_runtime.jsx)("div", { className: d, ...!d && { style: { width: "100%", height: "100%", lineHeight: 0, ...l1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: k1, style: { width: "100%", height: "100%" }, ...Z }) });
};
var h0 = (h) => new V1(h);
var O0 = (h) => (0, import_jsx_runtime.jsx)(K1, { ...h, createDotLottie: h0 });
var u0 = (h) => new J1(h);
