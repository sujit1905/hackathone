...
const EventDetails = () => {
  ...
  return (
    <div className="pb-12">
      {/* Hero */}
      <section className="mb-8 rounded-3xl bg-gradient-to-r from-[#020617] via-[#0f172a] to-[#0f766e] px-6 py-6 md:px-10 md:py-8 text-white flex flex-col lg:flex-row gap-8 items-center">
        <div className="w-full lg:w-[420px] rounded-2xl overflow-hidden bg-black/20">
          <img
            src={event.banner}
            alt={event.title}
      ...
      <div className="grid gap-6 lg:grid-cols-[260px,1fr] items-start">
        ...
        <aside className="sticky top-28 rounded-3xl bg-gradient-to-b from-[#020617] via-[#111827] to-[#020617] p-4 text-sm text-white">
        ...
        <div className="space-y-6">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-5 text-sm">
              ...
              <div className="rounded-2xl bg-[#f6ffed] p-4 space-y-1">
                <p className="text-xs font-semibold text-slate-700 flex items-center gap-1">
                  <MdOutlineLocationOn className="w-3.5 h-3.5" />
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl bg-[#fff7e6] p-5 text-center">
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-[#ffe7bf] text-slate-900">
                  <HiMiniTrophy className="h-6 w-6" />
                </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-[260px,1fr] gap-6">
              <div className="rounded-3xl bg-gradient-to-b from-[#020617] via-[#111827] to-[#020617] p-4 text-white">
